...
def main(stdscr):
	...
	n				= 11	# Gear ratio []
	deg_per_step	= 90	# Degrees to increment per step (on the output)
	...
	out_filename = get_output_filename('out_impact_testing.csv', stdscr)
	...
	line += 1; stdscr.addstr(line,0,'Use +/- to increase/decrease position, or press \'q\' to stop.'); line += 1; line += 1
	...
	while True:
		...
		outputVel   = 0#my_drive.axis1.encoder.vel_estimate
